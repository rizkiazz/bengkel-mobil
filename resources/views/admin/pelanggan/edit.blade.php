        ...
        <div class="col-lg-12">
            <div class="card ">
                ...
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Form Edit Pelanggan
                        <a href="{{ url('admin/pelanggan') }}" class="text-white btn btn-inverse float-right"><i class="fa fa-arrow-left"></i> Kembali</a>
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ url('admin/pelanggan/'.$pelanggan->id) }}" method="POST" class="form-horizontal" id="storeform">
                        @csrf
                        @method("PUT")
                        <div class="form-body">
                            <h3 class="box-title">Pelanggan Info</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="nama" name="nama" class="form-control" autocomplete="off" placeholder="Masukan teks..." value="{{ $pelanggan->nama }}">
                                            @error('nama')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <select name="tipe" id="tipe" class="form-control custom-select">
                                                ...
                                                <option value="basic" {{ $pelanggan->tipe == 'basic' ? 'selected' : '' }}>Basic</option>
                                                <option value="standar" {{ $pelanggan->tipe == 'standar' ? 'selected' : '' }}>Standar</option>
                                                <option value="premium" {{ $pelanggan->tipe == 'premium' ? 'selected' : '' }}>Premium</option>
                                            </select>
                                            @error('tipe')
                                                <small class="form-control-feedback text-danger"> {{ $message }} </small>
                                            @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="no_polisi" name="no_polisi" class="form-control" autocomplete="off" placeholder="Masukan teks..." value="{{ $pelanggan->no_polisi }}">
                                            @error('no_polisi')
                                                <small class="form-control-feedback text-danger"> {{ $message }} </small>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="alamat" name="alamat" class="form-control" autocomplete="off" placeholder="Masukan teks..." value="{{ $pelanggan->alamat }}">
                                            @error('alamat')
                                                <small class="form-control-feedback text-danger"> {{ $message }} </small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="input-group">
                                                ...
                                                <input type="number" id="handphone" name="handphone" class="form-control" autocomplete="off" placeholder="8xxxxxxxxxx" value="{{ $pelanggan->handphone }}" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==12) return false;">
                                            </div>
                                            @error('handphone')
                                                <small class="form-control-feedback text-danger"> {{ $message }} </small>
                                            @enderror
...
@push('script')
    <script>
        ...
        $('#storeform').submit(function() {
            if($('#nama').val() !== ''){
                    window.location= "/admin/pelanggan/"
